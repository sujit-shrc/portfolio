...
const TyperComponent: React.FC = () => {
  ...
  return (
    <div className="font-limelight text-center text-3xl md:text-4xl lg:text-5xl font-semibold min-h-[calc(100vh-320px)] md:min-h-[calc(100vh-270px)] flex items-center p-4">
