...
const TyperComponent: React.FC = () => {
  ...
  return (
    <div className="font-limelight text-center text-3xl md:text-4xl lg:text-5xl font-semibold min-h-[calc(100vh-280px)] md:min-h-[calc(100vh-300px)] flex items-center p-4">
